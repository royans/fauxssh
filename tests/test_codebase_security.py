...
def test_no_hardcoded_secrets():
    ...
    SECRET_PATTERNS = [
        ...
        (r'GOOGLE_API_KEY\s*=\s*["\'][^<]', "Hardcoded GOOGLE_API_KEY assignment"), # Ignore template values
    ]
    
    # Whitelisted files/directories
    EXCLUDE_DIRS = {'.git', '__pycache__', 'venv', 'env', 'data', 'egg-info', '.pytest_cache'}
    EXCLUDE_FILES = {'aws_keys.txt', '.env.example', 'credentials', 'test_codebase_security.py', 'publish_fauxssh.sh'}
            ...
            try:
                ...
                for pattern, name in SECRET_PATTERNS:
                    ...
                    for match in matches:
                        ...
                        if "your_key_here" in match or "fake_key" in match or "AIzaSy_FAKE" in match:
                            continue
