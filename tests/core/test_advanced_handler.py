...
class TestAdvancedHandler:
    ...
    def test_head_file(self, handler):
        ...
        with patch.object(handler.head_handler, '_generate_or_get_content', return_value=("LineA\nLineB\nLineC\n", "local")) as mock_get:
    ...
    def test_debug_commands_access(self, handler):
        # Trusted IP
        with patch('ssh_honeypot.core.command_handler.get_ignored_ips', return_value=['1.2.3.4']):
