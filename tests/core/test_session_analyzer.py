...
class TestSessionAnalyzer(unittest.TestCase):
    ...
    def test_cache_hit(self):
        ...
        self.mock_db.update_session_summary.assert_called_with(self.session_id, "Cached Summary", 8)
        self.mock_llm.generate_session_summary.assert_not_called()
    ...
    def test_llm_analysis(self):
        ...
        self.mock_db.update_session_summary.assert_called_with(self.session_id, expected_summary, 9)
