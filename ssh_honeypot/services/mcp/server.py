...
def check_quota_and_throttle(client_ip):
    ...
    """
    now = time.time()
    state = CLIENT_STATE.setdefault(client_ip, {'llm_calls': 0, 'last_req': 0, 'req_count': 0})
...
def tool_run_system_command(command: str, cmd_handler, db, session_id: str = "default") -> str:
