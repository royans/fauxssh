        ...
        while True:
            ...
            try:
                ...
                db.log_interaction(
                    ...
                    "/", 
                    command, 
                    response.decode('utf-8', errors='ignore'), # Store response as string for log
...
def start_redis_server(port, db, llm):
    ...
    try:
        ...
        while True:
            ...
            client_handler = threading.Thread(target=handle_redis_client, args=(client, addr, db, llm))
